...
target("ThorTest")
	set_kind("binary")
	add_includedirs("engine", "engine/core", "engine/renderer", "platform/linux/GLFWwindow", "platform/linux/OpenglRenderer", "3rdparty/glad/include", "3rdparty/stb_image/include")
